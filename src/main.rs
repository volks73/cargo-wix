        ...
        .subcommand(
            SubCommand::with_name(SUBCOMMAND_NAME)
                ...
                .arg(Arg::with_name("no-build")
                    .help("Skips building the release binary. The installer is created, but the 'cargo build --release' is not executed.")
                    .long("no-build"))
                ...
                .arg(Arg::with_name("output")
                    .help("Sets the destination file name and path for the created installer. The default is to create an installer with the '<product-name>-<version>-<arch>.msi' file name in the 'target\\wix' folder.")
                    .long("output")
                    .short("o")
                    .takes_value(true))
