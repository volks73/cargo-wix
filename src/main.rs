        ...
        .subcommand(
            SubCommand::with_name(SUBCOMMAND_NAME)
                ...
                .arg(Arg::with_name("sign-path")
                    .help("Specifies the path to the folder containg the 'signtool' application. The default is to use the PATH system environment variable to locate the application.")
                    .long("sign-path")
                    .short("S")
                    .takes_value(true))
